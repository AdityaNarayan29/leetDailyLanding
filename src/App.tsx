...
import { Chrome, Flame, BarChart3, Tag, Link, CheckCircle, Github, Twitter, Target, Zap, Users, Star } from 'lucide-react';
        ...
        <div className="relative max-w-6xl mx-auto px-6 py-20">
          <div className="text-center">
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-orange-500/20 to-red-500/20 border border-orange-500/30 rounded-full px-4 py-2 mb-8 backdrop-blur-sm">
              ...
              <span className="text-sm font-medium text-orange-200">Chrome Extension</span>
            </div>
            
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">
              Never Miss a LeetCode<br />
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-10 max-w-4xl mx-auto leading-relaxed">
              LeetDaily brings the Daily LeetCode Challenge directly to your browser. One-click access, 
              real-time insights, and streak tracking — stay consistent, stay interview-ready.
            </p>
      ...
      <div className="max-w-6xl mx-auto px-6 py-20">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Designed specifically for developers who want to maintain their coding edge
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="group bg-gradient-to-br from-gray-800/50 to-gray-900/50 border border-gray-700/50 rounded-2xl p-8 backdrop-blur-sm hover:border-orange-500/50 transition-all duration-300 hover:transform hover:scale-105">
            ...
            <h3 className="text-xl font-semibold text-white mb-3">Daily Challenge at a Glance</h3>
            <p className="text-gray-400 leading-relaxed">
              Always up-to-date with the latest LeetCode Daily. See today's problem the moment you open a new tab.
            </p>
          </div>
          ...
          <div className="group bg-gradient-to-br from-gray-800/50 to-gray-900/50 border border-gray-700/50 rounded-2xl p-8 backdrop-blur-sm hover:border-orange-500/50 transition-all duration-300 hover:transform hover:scale-105">
            ...
            <h3 className="text-xl font-semibold text-white mb-3">Difficulty & Acceptance Rate</h3>
            <p className="text-gray-400 leading-relaxed">
              Instantly know what you're up against with clear difficulty indicators and success rates.
            </p>
          </div>
          ...
          <div className="group bg-gradient-to-br from-gray-800/50 to-gray-900/50 border border-gray-700/50 rounded-2xl p-8 backdrop-blur-sm hover:border-orange-500/50 transition-all duration-300 hover:transform hover:scale-105">
            ...
            <h3 className="text-xl font-semibold text-white mb-3">Topic Tags</h3>
            <p className="text-gray-400 leading-relaxed">
              Stay focused on Arrays, DP, Graphs, and more. Know exactly what concepts you're practicing.
            </p>
          </div>
          ...
          <div className="group bg-gradient-to-br from-gray-800/50 to-gray-900/50 border border-gray-700/50 rounded-2xl p-8 backdrop-blur-sm hover:border-orange-500/50 transition-all duration-300 hover:transform hover:scale-105">
            ...
            <p className="text-gray-400 leading-relaxed">
              Go straight to the problem, no login needed. Skip the navigation and jump right into coding.
            </p>
          </div>
          ...
          <div className="group bg-gradient-to-br from-gray-800/50 to-gray-900/50 border border-gray-700/50 rounded-2xl p-8 backdrop-blur-sm hover:border-orange-500/50 transition-all duration-300 hover:transform hover:scale-105">
            ...
            <h3 className="text-xl font-semibold text-white mb-3">Streak Tracker</h3>
            <p className="text-gray-400 leading-relaxed">
              Visualize your daily consistency and boost motivation. Watch your streak grow day by day.
            </p>
          </div>
          ...
          <div className="group bg-gradient-to-br from-gray-800/50 to-gray-900/50 border border-gray-700/50 rounded-2xl p-8 backdrop-blur-sm hover:border-orange-500/50 transition-all duration-300 hover:transform hover:scale-105">
            ...
            <p className="text-gray-400 leading-relaxed">
              No ads. No clutter. Just pure LeetCode consistency in a clean, distraction-free interface.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-20 border-t border-gray-800/50">
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-orange-500/20 to-red-500/20 border border-orange-500/30 rounded-full px-6 py-3 mb-6 backdrop-blur-sm">
            ...
            <span className="text-lg font-medium text-orange-200">Loved by 1000+ LeetCoders and counting</span>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-gray-800/30 to-gray-900/30 border border-gray-700/30 rounded-xl p-6 backdrop-blur-sm">
              ...
              <p className="text-gray-300 mb-4">"Finally, a clean way to track my daily LeetCode without getting distracted by other features. My streak has never been longer!"</p>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-400">Software Engineer @ Google</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-gray-800/30 to-gray-900/30 border border-gray-700/30 rounded-xl p-6 backdrop-blur-sm">
              ...
              <p className="text-gray-300 mb-4">"Perfect for my #100DaysOfCode challenge. The streak tracker keeps me motivated and accountable every single day."</p>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-400">CS Student @ Stanford</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-gray-800/30 to-gray-900/30 border border-gray-700/30 rounded-xl p-6 backdrop-blur-sm">
              ...
              <p className="text-gray-300 mb-4">"As a busy professional, this extension helps me stay sharp with just 15 minutes a day. Interview prep made simple."</p>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-400">Senior Dev @ Meta</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-gradient-to-r from-gray-900/50 to-black/50 border border-orange-500/30 rounded-3xl p-12 backdrop-blur-sm">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              Building a daily coding habit isn't just about solving problems—it's about staying interview-ready, 
              sharpening your problem-solving skills, and maintaining your competitive edge in tech.
            </p>
            
            <div className="grid md:grid-cols-3 gap-8 mt-12">
              <div className="text-center">
                <div className="text-3xl font-bold text-orange-400 mb-2">🎯</div>
                <h3 className="text-lg font-semibold text-white mb-2">Build Habits</h3>
                <p className="text-gray-400">Turn coding practice into an automatic daily routine</p>
              </div>
              
              <div className="text-center">
                <div className="text-3xl font-bold text-orange-500 mb-2">💼</div>
                <h3 className="text-lg font-semibold text-white mb-2">Stay Interview-Ready</h3>
                <p className="text-gray-400">Always prepared for that dream job opportunity</p>
              </div>
              
              <div className="text-center">
                <div className="text-3xl font-bold text-amber-400 mb-2">📈</div>
                <h3 className="text-lg font-semibold text-white mb-2">Stay Accountable</h3>
                <p className="text-gray-400">Visual progress tracking keeps you motivated</p>
              </div>
            </div>
            
            <div className="mt-10 p-6 bg-gradient-to-r from-gray-800/50 to-gray-900/50 border border-gray-700/50 rounded-xl">
              <p className="text-lg text-gray-300">
                <span className="font-semibold text-white">"No ads. No clutter. Just pure LeetCode consistency."</span>
                <br />
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="mt-8 pt-8 border-t border-gray-800/50 text-center">
            <p className="text-gray-400">
              <span className="font-medium text-white">Built for developers, by developers.</span>
              <br />
              <span className="text-sm">© 2025 LeetDaily. Privacy-first. No data collection.</span>
            </p>
          </div>
        </div>
      </footer>
